...
def main():
    try:
        ...
        resp2 = post_user(user2_id, "UserpThree002", "u300002@example.com")
        ...
        #    ensure NOT BOTH are successful (status=201).
        #    We will also track the total cost for each user.
        user1_total_spent = 0
        user2_total_spent = 0
        ...
        for i in range(10):
            ...
            # We never want both to succeed for the same pair
        ...
        # expected final = total_needed - whatever user spent
